// build.zig — Android native build for minutemodem_mobile.
//
...
//     Output: libminutemodem_mobile.so installed to
//     android/app/src/main/jniLibs/<abi>/libminutemodem_mobile.so so
