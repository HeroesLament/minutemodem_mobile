defmodule MinutemodemMobile.ListScreen do
  ...
  def handle_info(:reveal, socket) do
    ...
    MinutemodemMobile.Repo.insert!(%MinutemodemMobile.Round{
      user_choice:     user,
  ...
  defp load_rounds do
    MinutemodemMobile.Repo.all(
      from r in MinutemodemMobile.Round,
  ...
  defp history_row(%MinutemodemMobile.Round{} = round) do
    {badge, color} =
