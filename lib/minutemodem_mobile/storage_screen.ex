defmodule MinutemodemMobile.StorageScreen do
  use Mob.Screen
  ...
  def handle_info({:tap, :write}, socket) do
    path = Path.join(Mob.Storage.dir(:documents), "minutemodem_mobile_test.txt")
    case Mob.Storage.write(path, "MinutemodemMobile storage test\n#{DateTime.utc_now()}") do
